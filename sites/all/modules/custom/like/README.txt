...
A module that allows users to cast a Like vote.
...
- Then copy the like folder to your sites/all/modules directory.
...
First off, you can change the 'You voted' text on the module admin page ?q=admin/settings/like.

Additionally, you can override the theming function theme_like_widget in your theme.

From like.module theme_like_widget function header:
